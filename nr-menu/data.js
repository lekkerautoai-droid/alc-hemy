// NR Botanicals — shared catalog used by all 3 directions.
// Keeps prices/strains in one place so each direction just restyles.
...
window.NR = {
  ...
  // FLOWER — categories from the original menu, with strain meta filled in.
  // type / thc / terps / effect are placeholders the owner can edit later.
  flower: [
    {
      category: 'Greenhouse',
  ...
  // CONCENTRATES — Live Rosin from page 1 + Distillates from page 2.
  concentrates: [
    {
      category: 'Live Rosin',
  ...
  // EDIBLES & WELLNESS — RSO from page 2.
  edibles: [
    {
  ...
  // MUSHROOMS — Happy Caps from page 2.
  mushrooms: [
    {
      category: 'Happy Caps',
